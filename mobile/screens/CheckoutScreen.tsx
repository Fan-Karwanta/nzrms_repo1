      ...
      try {
        if (!payLater) {
          const createPaymentIntentPayload: movininTypes.CreatePaymentPayload = {
            ...
            name: '',
            description: "NZ RMS Mobile Service",
        ...
        <>
          {formVisible && (
            <PropertyList
              ...
              {/* GCASH Button */}
              <TouchableOpacity style={styles.gcashButton} onPress={handleCheckout}>
                <Image
                  source={require('@/assets/gcash_icon.png')} // Add search icon to your assets folder
                  style={styles.gcashIcon}
                />
                <Text style={styles.gcashText}>{i18n.t('PAY_WITH_GCASH')}</Text>
              </TouchableOpacity>

              {/* PAY MAYA Button */}
              <TouchableOpacity style={styles.mayaButton} onPress={handleCheckout}>
                <Image
                  source={require('@/assets/maya_icon.png')} // Add Google Maps icon to your assets folder
                  style={styles.mayaIcon}
                />
                <Text style={styles.mayaText}>{i18n.t('PAY_WITH_MAYA')}</Text>
              </TouchableOpacity>
